<?php
  ...
  $data_hidden = array('ins_ui' => 'm'); // c for computer, m for mobile
  ...
  foreach($array_vehicles as $vehicle) {
    $array_dropdown[$vehicle['id']] = $vehicle['name'];
  }
  ...
  echo form_open('petrol/insert', '', $data_hidden) . "<br />\n";
